  ...
  return (
    <div className="min-h-screen bg-cream px-4 py-6 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold text-wine-900 mb-6">{t('onboarding.title')}</h1>
        <p className="text-gray-600 mb-8">{t('onboarding.welcome_desc')}</p>

        <div className="card mb-6">
          <h2 className="text-xl font-semibold text-wine-900 mb-2">{t('onboarding.preferences')}</h2>
          ...
          <div className="grid gap-4 sm:grid-cols-2 mb-6">
            <div>
              ...
              <input
                ...
                placeholder="Golan Heights Winery"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
